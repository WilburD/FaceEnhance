...
# 预测
def predict(input_image, label_image, save_path, image_size, model_type):
...
def u_net_main():
    ...
    if image_size == 256:
        ...
        predict(x, y, model_path_unet_64x64, image_size, model_type)
    else : # 64x64 
...
def encode_decode_main():
    ...
    if image_size == 256: # 256x256
        ...
        predict(x, y, model_path_endecode_64x64, image_size, model_type)
    else : # 64x64 
